...
var jsonTests = []struct {
	...
	{name: "unknown field in json", json: `{"fooo":"bar"}`, errorExpected: false, maxSize: 1024, allowUnknown: true},
	{name: "missing field name", json: `{jack:"1"}`, errorExpected: true, maxSize: 1024, allowUnknown: true},
	{name: "file to large", json: `{"bar":"bar"}`, errorExpected: true, maxSize: 5, allowUnknown: true},
	{name: "not json", json: `Hell world`, errorExpected: true, maxSize: 1024, allowUnknown: true},
}
